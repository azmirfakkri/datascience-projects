...
# Load wine_raw1 data
wine_raw1 <- read.csv(file = "/Users/azmirfakkri/Documents/OneDrive - Dublin Business School (DBS)/Programming for Big Data/CA/10383721/Dataset 1/winemag-data-130k-v2-1.csv",
                      header = TRUE, sep = ",")
...
wine_raw2 <- read.csv(file = "/Users/azmirfakkri/Documents/OneDrive - Dublin Business School (DBS)/Programming for Big Data/CA/10383721/Dataset 1/winemag-data-130k-v2-2.csv",
                      header = TRUE, sep = ",")
...
Some wine drinkers are interested in wine’s vintage year. Vintage year is the specified year in which the grapes are grown and harvested. This information can be extracted from the title column by specifying the rules in R using regular expressions. The new dataset is called wine_raw2.
